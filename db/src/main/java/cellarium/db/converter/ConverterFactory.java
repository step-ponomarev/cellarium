...
public final class ConverterFactory {
    private static final Map<DataType, Converter<?, MemorySegment>> CONVERTERS = new EnumMap<>(DataType.class);

    static {
        CONVERTERS.put(DataType.LONG, LongMemorySegmentConverter.INSTANCE);
        CONVERTERS.put(DataType.INTEGER, IntegerMemorySegmentConverter.INSTANCE);
