...
public final class RegExp {
    ...
    private static final String TABLA_NAME_PATTERN_TEMPLATE = "^[\\p{IsLatin}]{1}[\\p{IsLatin}_\\d]{%d,%d}[\\p{IsLatin}\\d]{1}$";

    public static final Pattern TABLE_NAME_PATTERN = Pattern.compile(
            String.format(TABLA_NAME_PATTERN_TEMPLATE, MIN_TABLE_NAME_LEN - 2, MAX_TABLE_NAME_LEN - 2)
    );
